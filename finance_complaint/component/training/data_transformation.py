...
class DataTransformation():
    ...
    def get_data_transformation_pipeline(self, ) -> Pipeline:  # arrange all the transformations one-by-one to a pipeline
        try:
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            # RDD, DataFrame cannot modify, so just generate a new column, then drop previous column
